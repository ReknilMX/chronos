...
describe "WB.CONTA Validar Perfil Cliente CE", :sauce => CONTAAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.link(:text => "DPIVA").should_not exist
...
describe "WB.CONTA Validar Perfil Contador CE", :sauce => CONTAAPP_CONFIG['sauce'] do
...
describe "WB.CONTA Validar Perfil Financiero CE", :sauce => CONTAAPP_CONFIG['sauce'] do
