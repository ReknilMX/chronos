...
describe "WB.CONTA - C7808 - Validar que el campo Fecha de la sección Cheque sea requerido para el archivo de Polizas", :sauce => CONTAAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.element(:name => "commit").click
    @driver.div(:class => 'alert alert-danger text-left').wait_until_present
    assert @driver.element(:id => "flash-alert").text.should == "Error en línea 8 Cheque 11: El campo Fecha debe contener un valor\nError en línea 8 Cheque 11: El campo Fecha tiene un formato inválido (yyyy-mm-dd)"
  end
...
describe "WB.CONTA - C7815 - Validar que el campo Fecha de la sección de Transferencia sea requerido para el archivo de Polizas", :sauce => CONTAAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.element(:name => "commit").click
    @driver.div(:class => 'alert alert-danger text-left').wait_until_present
    assert @driver.element(:id => "flash-alert").text.should == "Error en línea 9 Transferencia 9382716273: El campo Fecha debe contener un valor\nError en línea 9 Transferencia 9382716273: El campo Fecha tiene un formato inválido (yyyy-mm-dd)"
  end
...
describe "WB.CONTA - C7820 - Validar que el campo Fecha de la sección Otro Método de Pago sea requerido para el archivo de Pólizas", :sauce => CONTAAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.element(:name => "commit").click
    @driver.div(:class => 'alert alert-danger text-left').wait_until_present
    assert @driver.element(:id => "flash-alert").text.should == "Error en línea 10 OtrMetodoPago 01: El campo Fecha debe contener un valor\nError en línea 10 OtrMetodoPago 01: El campo Fecha tiene un formato inválido (yyyy-mm-dd)"
  end
...
describe "WB.CONTA - C7834 - Validar el campo Moneda con valores distintos a los del catálogo definido por el SAT para la sección CompNal", :sauce => CONTAAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.element(:name => "commit").click
    @driver.div(:class => 'alert alert-danger text-left').wait_until_present
    assert @driver.element(:id => "flash-alert").text.should == "Error en línea 5 CompNal e1a15bc8-de01-4101-8538-2a18ecb33b28: El campo: 'Moneda' no es válido, debe ser codigo ISO de moneda válido, favor de referirse al catálogo del SAT para encontrar los valores permitidos."
  end
...
describe "WB.CONTA - C7836 - Validar el campo Tipo de Cambio con letras para la sección Comp Nal del archivo de Pólizas", :sauce => CONTAAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.element(:name => "commit").click
    @driver.div(:class => 'alert alert-danger text-left').wait_until_present
    assert @driver.element(:id => "flash-alert").text.should == "Error en línea 5 CompNal e1a15bc8-de01-4101-8538-2a18ecb33b28: El campo TipCamb debe ir vacio cuando el campo Moneda es MXN"
  end
