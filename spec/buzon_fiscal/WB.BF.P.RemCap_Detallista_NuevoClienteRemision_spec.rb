...
describe "WB.BF.AD.P.RemCap Detallista Nuevo Cliente Remision", :sauce => BFAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.find_element(:id, "detallista.buyer.gln").send_keys "Prueba Diverza A"
    @driver.find_element(:id, "detallista.buyer.contactInformation.personOrDepartmentName.text").clear
    @driver.find_element(:id, "detallista.buyer.contactInformation.personOrDepartmentName.text").send_keys "Pruebas Buzon Fiscal Diverza"
    @driver.find_element(:id, "detallista.seller.gln").clear
    @driver.find_element(:id, "detallista.seller.gln").send_keys "Prueba Diverza A"
    ...
    @driver.find_element(:id, "concepto.descripcion").send_keys "Prueba Diverza"
