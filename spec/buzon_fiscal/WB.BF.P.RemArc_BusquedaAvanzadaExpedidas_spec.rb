...
describe "WB.BF.P.RemArc Busqueda Avanzada Expedidas", :sauce => BFAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.find_element(:id, "status3").click
    ...
    verify { (@driver.find_element(:xpath, "//table[@id='remision']/tbody/tr[1]/td[8]").text).should == "Expedida" }
