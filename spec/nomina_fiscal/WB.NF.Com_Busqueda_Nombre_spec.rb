...
describe "WB.NF.Com Busqueda Nombre Administrador", :sauce => NFAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.find_element(:id, "q_rfc_receiver_or_payroll_complement_employee_number_or_razon_social_receiver_or_payroll_complement_department_or_payroll_complement_curp_cont").send_keys "Prueba Empleado 01"
...
describe "WB.NF.Com Busqueda Nombre Operador", :sauce => NFAPP_CONFIG['sauce'] do
...
describe "WB.NF.Com Busqueda Nombre Human Resources", :sauce => NFAPP_CONFIG['sauce'] do
...
describe "WB.NF.Com Busqueda Nombre Conector", :sauce => NFAPP_CONFIG['sauce'] do
...
describe "WB.NF.Com Busqueda Nombre Timbre", :sauce => NFAPP_CONFIG['sauce'] do
