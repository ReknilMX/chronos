...
describe "WB.NF.Com Busqueda CURP Administrador", :sauce => NFAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    @driver.find_element(:id, "q_rfc_receiver_or_payroll_complement_employee_number_or_razon_social_receiver_or_payroll_complement_department_or_payroll_complement_curp_cont").send_keys "TEST010101HDFTHR01"
...
describe "WB.NF.Com Busqueda CURP Operador", :sauce => NFAPP_CONFIG['sauce'] do
...
describe "WB.NF.Com Busqueda CURP Human Resources", :sauce => NFAPP_CONFIG['sauce'] do
...
describe "WB.NF.Com Busqueda CURP Conector", :sauce => NFAPP_CONFIG['sauce'] do
...
describe "WB.NF.Com Busqueda CURP Timbre", :sauce => NFAPP_CONFIG['sauce'] do
