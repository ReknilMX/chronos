...
describe "WB.CF.P.ComAem Enviar EMAIL", :sauce => CFAPP_CONFIG['sauce'] do
  ...
  it Time.now do
    ...
    verify { (@driver.find_element(:css, "p.mensaje").text).should == "Se ha efectuado con éxito el envío del o los comprobante(s) seleccionado(s). Recibirá una notificación cuando el documento haya sido descargado por el receptor." }
  end
