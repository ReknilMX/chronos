...
describe "T4779 WB.SP.RE.P.RemCap Captura correcta NdC", :sauce => SPAPP_CONFIG['sauce'] do
  
  include_context "config"
  include_context "login_reciclaje"
  ...
  it Time.now do
    ...
    Selenium::WebDriver::Support::Select.new(@driver.find_element(:id, "tipCFD")).select_by(:text, "Nota de Credito")
